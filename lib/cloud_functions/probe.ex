defmodule CloudFunctions.Probe do
  ...
  def probe_transfer() do
    backends = [{:aws,    [memory:  128, case: 1], "https://n1112vxae9.execute-api.eu-west-1.amazonaws.com/dev/hello-128"},
                ...
                {:aws,    [memory:  128, case: 2, task: 'upload', region: 'us-east-1'], "https://gzv6gpwy97.execute-api.us-east-1.amazonaws.com/prod/upload-128"},
                {:aws,    [memory:  128, case: 2, task: 'download', region: 'us-east-1'], "https://gzv6gpwy97.execute-api.us-east-1.amazonaws.com/prod/download-128"},
                {:aws,    [memory:  256, case: 2, region: 'us-east-1'], "https://gzv6gpwy97.execute-api.us-east-1.amazonaws.com/prod/transfer-256"},
                {:aws,    [memory:  512, case: 2, region: 'us-east-1'], "https://gzv6gpwy97.execute-api.us-east-1.amazonaws.com/prod/transfer-512"},
                {:aws,    [memory:  1024, case: 2, region: 'us-east-1'], "https://gzv6gpwy97.execute-api.us-east-1.amazonaws.com/prod/transfer-1024"},
                {:aws,    [memory:  1536, case: 2, region: 'us-east-1'], "https://gzv6gpwy97.execute-api.us-east-1.amazonaws.com/prod/transfer-1536"},
